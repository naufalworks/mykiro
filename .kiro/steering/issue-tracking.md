---
name: Issue Tracking
description: Memory system, issue tracking, and forever recall
type: global
inclusion: always
priority: critical
---

# Issue Tracking & Memory System - Global Rules
...
└─ ISS-003: Inefficient database queries
   ...
   Age: 3 days
   Impact: Low - slow response times
...
Pending (5):
├─ TASK-159: Fix database queries
├─ TASK-160: Add error logging
└─ ... (3 more)

Completed Today (4):
├─ TASK-001: Add login button (25 min)
├─ TASK-002: Fix auth bug (1 hour)
└─ ... (2 more)
